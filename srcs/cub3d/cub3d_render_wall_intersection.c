...
/*   Updated: 2020/05/08 14:58:13 by bvalette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_intersect		ft_wall_vertical(t_data *data, double alpha_deg)
{
	...
	output = ft_cell_type(data, data->map->grid, inter.coord, alpha_deg, VERTICAL);
...
t_intersect		ft_wall_horizontal(t_data *data, double alpha_deg)
{
	...
	output = ft_cell_type(data, data->map->grid, inter.coord, alpha_deg, HORIZONTAL);
	while (output != WALL && output != ERROR)
	{
